...
## Notes
* 'ecommerce_demo.postman_collection.json' file is present at the root of the project. It has all the apis to test if one wants to use. The postman export format is v2.1
